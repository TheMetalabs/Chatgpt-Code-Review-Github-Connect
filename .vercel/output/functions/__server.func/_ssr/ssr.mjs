...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-vyrRH_yN.mjs");
...
var manifest = { "07cc63413fde82899e3b082fc2eaa848094b93fb1e6f1caa688cf892808c0ce2": {
	functionName: "runLiveReview_createServerFn_handler",
	importer: () => import("./live-Pw6CbKha.mjs")
} };
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-Cie5IrZk.mjs").then((n) => n.t),
