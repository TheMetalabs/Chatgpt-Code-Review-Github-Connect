...
const OPEN: ReadonlyArray<readonly [string, string]> = [
  ["start", "start:admission | success,unknown-landed | normal | row-appears"],
  ["start", "start:admission | success | lagging | *"],
  ["start", "start:admission | success | failing | 25h,row-appears"],
  ["start", "start:admission | rejected | lagging | newer-start"],
  ["start", "start:self-heal | success,unknown-landed | normal,failing | row-appears"],
  ["start", "start:self-heal | success,unknown-landed | lagging | *"],
  ["start", "start:self-heal | rejected | * | *"],
  ["start", "start:self-heal | unknown-lost | normal,lagging | *"],
  ["start", "start:self-heal | unknown-lost | failing | row-appears"],
  ["start", "continue:push | success | lagging | newer-start"],
  ["start", "continue:applied | success,unknown-landed,unknown-lost | lagging | newer-start"],
  ["start", "continue:superseded | success | lagging | newer-start"],
  ["start", "continue:moved-mid-round | success | lagging | newer-start"],
  ...
  ["handoff", "handoff:stuck | rejected | lagging | newer-start"],
  ...
  ["handoff", "handoff:terminal | rejected | lagging | newer-start"],
