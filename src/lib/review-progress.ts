...
export const PROGRESS_LABELS = {
    ...
    overlays_dismissing: "Prompt not sent · dismissing page dialogs",
    composer_waiting: "Prompt not sent · waiting for composer",
    composer_ready: "Prompt not sent · composer ready",
    ...
    attachments_staged_via_b: "Attachments staged · pasted into the editor (strategy b)",
    attachments_staged_via_c: "Attachments staged · dropped onto the composer (strategy c)",
    attachments_staged_via_d: "Attachments staged · through the file input the + menu added (strategy d)",
