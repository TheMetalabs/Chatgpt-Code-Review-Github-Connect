...
import {bridgeHarness, job as makeJob, source} from './load-source.mjs';
...
function server(jobs = []) {
  ...
  const c = vm.createContext({Response, URL, createFileRoute: () => config => config, bridgePromptText: text => text,
